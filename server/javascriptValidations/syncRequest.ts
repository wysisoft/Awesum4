...
lastModified: { default: 1765664171165, type: 'number' },
homePageImageType: {
default: 0,
minimum: 0,
maximum: 3,
...
id: {
default: '019b19c9-249e-75e8-b6b4-036be036863d',
format: 'uuid',
minLength: 36,
type: 'string'},
...
properties: {
id: {
default: '019b19c9-249e-75e8-b6b4-14e90e3b9482',
format: 'uuid',
type: 'string'},
...
(data88.id === undefined &&
(missing7 = 'id')) ||
(data88.appId === undefined &&
(missing7 = 'appId')) ||
(data88.routerMac === undefined &&
(missing7 = 'routerMac')) ||
(data88.ipAddress === undefined &&
(missing7 = 'ipAddress')) ||
(data88.mondayTimesAndDurations === undefined &&
(missing7 = 'mondayTimesAndDurations')) ||
(data88.tuesdayTimesAndDurations === undefined &&
(missing7 = 'tuesdayTimesAndDurations')) ||
(data88.wednesdayTimesAndDurations === undefined &&
(missing7 = 'wednesdayTimesAndDurations')) ||
(data88.thursdayTimesAndDurations === undefined &&
(missing7 = 'thursdayTimesAndDurations')) ||
(data88.fridayTimesAndDurations === undefined &&
(missing7 = 'fridayTimesAndDurations')) ||
(data88.saturdayTimesAndDurations === undefined &&
(missing7 = 'saturdayTimesAndDurations')) ||
(data88.sundayTimesAndDurations === undefined &&
(missing7 = 'sundayTimesAndDurations')) ||
(data88.version === undefined &&
(missing7 = 'version')) ||
(data88.lastModified === undefined &&
(missing7 = 'lastModified')) ||
(data88.touched === undefined &&
(missing7 = 'touched')) ||
(data88.status === undefined &&
(missing7 = 'status'))
) {errors.push(
{
...
if (valid7) {
if (data88.appId !== undefined) {
let data90 = data88.appId
...
if (valid7) {
if (data88.routerMac !== undefined) {
let data91 = data88.routerMac
const _errs183 = errors
if (true) {
if (true) {
if (typeof data91 === 'string') {
if (!pattern1.test(data91)) {errors.push(
{
...
if (!formats100(data91)) {errors.push(
{
instancePath: instancePath + '/router/routerMac',
...
if (valid7) {
if (data88.ipAddress !== undefined) {
let data92 = data88.ipAddress
...
let data93 = data88.mondayTimesAndDurations
...
if (!formats100(data93)) {errors.push(
{
instancePath: instancePath + '/router/mondayTimesAndDurations',
...
let data94 = data88.tuesdayTimesAndDurations
...
let data95 = data88.wednesdayTimesAndDurations
...
let data96 = data88.thursdayTimesAndDurations
...
let data97 = data88.fridayTimesAndDurations
...
let data98 = data88.saturdayTimesAndDurations
...
let data99 = data88.sundayTimesAndDurations
...
let data101 = data88.lastModified
...
let data104 = data.followerDatabaseCompletion
...
let missing8
if (
(data104.id === undefined &&
(missing8 = 'id')) ||
(data104.followerRequestId === undefined &&
(missing8 = 'followerRequestId')) ||
(data104.itemId === undefined &&
(missing8 = 'itemId')) ||
(data104.parentItemId === undefined &&
(missing8 = 'parentItemId')) ||
(data104.itemLevel === undefined &&
(missing8 = 'itemLevel')) ||
(data104.lastModified === undefined &&
...
let data106 = data104.followerRequestId
...
if (valid8) {
if (data104.itemId !== undefined) {
let data107 = data104.itemId
...
let data108 = data104.parentItemId
...
let data110 = data104.lastModified
