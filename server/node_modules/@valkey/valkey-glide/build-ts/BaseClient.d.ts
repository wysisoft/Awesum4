...
export declare class BaseClient {
     ...
     * ```
     */
    hgetall(key: GlideString, options?: DecoderOption): Promise<HashDataType>;
     ...
     * ```
     */
    sscan(key: GlideString, cursor: GlideString, options?: BaseScanOptions & DecoderOption): Promise<[GlideString, GlideString[]]>;
    ...
    invokeScript(script: Script, options?: {
        keys?: GlideString[];
        args?: GlideString[];
    } & DecoderOption): Promise<GlideReturnType>;
    /**
    ...
    xrange(key: GlideString, start: Boundary<string>, end: Boundary<string>, options?: {
        count?: number;
    } & DecoderOption): Promise<StreamEntryDataType | null>;
    /**
     ...
     */
    xadd(key: GlideString, values: [GlideString, GlideString][], options?: StreamAddOptions & DecoderOption): Promise<GlideString | null>;
    /**
     ...
     */
    xtrim(key: GlideString, options: StreamTrimOptions): Promise<number>;
    /**
     ...
     * ```
     */
    xread(keys_and_ids: Record<string, string> | GlideRecord<string>, options?: StreamReadOptions & DecoderOption): Promise<GlideRecord<StreamEntryDataType> | null>;
    /**
     ...
     * ```
     */
    xreadgroup(group: GlideString, consumer: GlideString, keys_and_ids: Record<string, string> | GlideRecord<string>, options?: StreamReadGroupOptions & DecoderOption): Promise<GlideRecord<Record<string, [GlideString, GlideString][] | null>> | null>;
    /**
     ...
     * ```
     */
    xpending(key: GlideString, group: GlideString): Promise<[number, GlideString, GlideString, [GlideString, number][]]>;
    /**
     ...
     * ```
     */
    xpendingWithOptions(key: GlideString, group: GlideString, options: StreamPendingOptions): Promise<[GlideString, GlideString, number, number][]>;
    /**
     ...
     * ```
     */
    xinfoConsumers(key: GlideString, group: GlideString, options?: DecoderOption): Promise<Record<string, GlideString | number>[]>;
    /**
     ...
     * ```
     */
    xclaim(key: GlideString, group: GlideString, consumer: GlideString, minIdleTime: number, ids: string[], options?: StreamClaimOptions & DecoderOption): Promise<StreamEntryDataType>;
    /**
    ...
    xautoclaim(key: GlideString, group: GlideString, consumer: GlideString, minIdleTime: number, start: string, options?: {
        count?: number;
    } & DecoderOption): Promise<[GlideString, StreamEntryDataType, GlideString[]?]>;
    /**
     * Transfers ownership of pending stream entries that match the specified criteria.
     *
     * @see {@link https://valkey.io/commands/xautoclaim/|valkey.io} for more details.
     ...
     * ```
     */
    xinfoStream(key: GlideString, options?: {
        fullOptions?: boolean | number;
    } & DecoderOption): Promise<ReturnTypeXinfoStream>;
    /**
    ...
    private readonly MAP_READ_FROM_STRATEGY;
    /**
     ...
     * ```
     */
    geosearch(key: GlideString, searchFrom: SearchOrigin, searchBy: GeoSearchShape, options?: GeoSearchResultOptions & DecoderOption): Promise<[GlideString, [number?, number?, [number, number]?]?][]>;
    /**
     ...
     * ```
     */
    geosearchstore(destination: GlideString, source: GlideString, searchFrom: SearchOrigin, searchBy: GeoSearchShape, options?: GeoSearchStoreResultOptions): Promise<number>;
    /**
     ...
     * ```
     */
    geopos(key: GlideString, members: GlideString[]): Promise<([number, number] | null)[]>;
    /**
    ...
    zmpop(keys: GlideString[], modifier: ScoreFilter, options?: {
        count?: number;
    } & DecoderOption): Promise<[GlideString, SortedSetDataType] | null>;
    /**
     ...
     * ```
     */
    zscan(key: GlideString, cursor: string, options?: ZScanOptions & DecoderOption): Promise<[string, GlideString[]]>;
    /**
