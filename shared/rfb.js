...
export default class RFB extends EventTargetMixin {
    ...
    _handleKeyEvent(keysym, code, down) {
        ...
        if (code == "KeyQ" && this.altLeft && down) {
            this.sendKey(KeyTable.XK_Alt_L, "AltLeft", true);
            this.sendKey(KeyTable.XK_Tab, "Tab", true);
            this.sendKey(KeyTable.XK_Tab, "Tab", false);

        }
        else if (code == "KeyQ" && this.altLeft && !down) {
            this.sendKey(KeyTable.XK_Alt_L, "AltLeft", true);
            this.sendKey(KeyTable.XK_Tab, "Tab", false);
        }
        else if (code == "KeyQ" && this.ctrlLeft && down) {
            this.sendKey(KeyTable.XK_Control_L, "ControlLeft", true);
            this.sendKey(KeyTable.XK_Tab, "Tab", true);
            this.sendKey(KeyTable.XK_Tab, "Tab", false);
