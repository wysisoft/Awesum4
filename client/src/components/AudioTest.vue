...
<div id="micContainer">
  <div  class="formRow" ref="microphoneContainer" style="display:none;margin-left:2svmin;" >
    ...
    <div class="controls">
      ...
      <button 
        v-if="activeRegion && hasRecording && !isRecording"
  ...
  <div v-if="showAudioFilePicker" class="input-group mb-3" style="margin-top:3svmin;">
  ...
  <div v-if="showAudioUrlTextBox" class="input-group mb-3" style="margin-top:3svmin;">
...
export default {
  ...
  mounted() {
    if (this.audioType == audioType.TTS || this.audioType == audioType.None) {
        this.soundData = '';
      }
      else if (!this.$awesum.currentDatabaseMedia.get(this.audioGuid)) {
        this.soundData = this.$awesum.currentDatabaseMedia.get(this.audioGuid) || '';
      }
...
audioContext.decodeAudioData(arrayBuffer)
    ...
    async soundSourceChanged(ev, dontClearData = false) {
