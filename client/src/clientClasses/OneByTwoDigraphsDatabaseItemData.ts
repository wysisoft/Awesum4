  ...
  export class ClientOneByTwoDigraphsDatabaseItemData implements ServerOneByTwoDigraphsDatabaseItemDataInterface {
      constructor(other?:Partial<ServerOneByTwoDigraphsDatabaseItemDataInterface>|null, table?: Table) {
          if (other) {
    ...
    private _leftDigraphs: string = "";
    public get leftDigraphs():string { return this._leftDigraphs; }
    public set leftDigraphs(v:string) {if(this._leftDigraphs != v){this.parent.version++;this.parent.lastModified=new Date().getTime();this._leftDigraphs=v;awesum.setTablePropertyValueById(this.parent.id, 'data.leftDigraphs',v,this.parent.table)}}
    private _rightDigraphs: string = "";
    public get rightDigraphs():string { return this._rightDigraphs; }
    public set rightDigraphs(v:string) {if(this._rightDigraphs != v){this.parent.version++;this.parent.lastModified=new Date().getTime();this._rightDigraphs=v;awesum.setTablePropertyValueById(this.parent.id, 'data.rightDigraphs',v,this.parent.table)}}
