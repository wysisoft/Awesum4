  ...
  export class ClientSpellingDatabaseItem implements ServerSpellingDatabaseItemInterface {
      constructor(other?:Partial<ServerSpellingDatabaseItemInterface>|null, table?: Table) {
          if (other) {
