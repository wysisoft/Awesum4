  ...
  export class ClientOneByTwoDigraphsDatabaseItem implements ServerOneByTwoDigraphsDatabaseItemInterface {
      constructor(other?:Partial<ServerOneByTwoDigraphsDatabaseItemInterface>|null, table?: Table) {
          if (other) {
